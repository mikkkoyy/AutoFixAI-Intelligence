...
class MainWindow(QMainWindow):
    ...
    def backend_label_update(self, status):
        self.dashboard_backend_value.setProperty(
            "state",
            "online",
        )

        self.dashboard_backend_value.style().unpolish(
            self.dashboard_backend_value
        )

        self.dashboard_backend_value.style().polish(
            self.dashboard_backend_value
        )
